---
layout: post
title: Week Four / Systems
permalink: /personal/csa/week-four/
author: Hope Fune
...
<div class="csa-folder">
	...
	<div class="folder-top folder-reveal">
		<div>
			<div class="folder-kicker">WEEK 04 / APCSA</div>
			<h1 class="folder-title">Week Four</h1>
			<p class="folder-intro">Assignments and progress for the fourth week of CSA.</p>
		</div>
		<div class="folder-orbit" aria-hidden="true"></div>
	</div>

	<div class="folder-section-label">04 / choose a folder</div>
	<div class="folder-grid">
		<a class="folder-card folder-reveal" href="{{ site.baseurl }}/personal/csa/week-four/ground-0/"><span class="folder-card-number">FILE 01</span><span class="folder-icon" aria-hidden="true"></span><h2>Ground 0</h2></a>
	</div>
</div>
